...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Food <b style="color: #c1064e; ">Donation</b></p>
             <p class="user"></p>
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="highest-donator-link">
                    <a href="highest_donator.php">
                     <i class="uil uil-user"></i>
                     <span class="link-name">Highest Donator</span>
                    </a>
                 </div>
